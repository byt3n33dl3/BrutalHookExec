...
//	gEeprom.SCAN_LIST_DEFAULT = (Data[0] < 2) ? Data[0] : false;
	...
	gSetting_F_LOCK           = (Data[0] < FREQ_LOCK_LAST) ? Data[0] : F_LOCK_OFF;
	//gSetting_F_LOCK            = (Data[0] < 6) ? Data[0] : F_LOCK_OFF;
	gSetting_350TX             = (Data[1] < 2) ? Data[1] : true;  // was true
	gSetting_KILLED            = (Data[2] < 2) ? Data[2] : false;
	gSetting_200TX             = (Data[3] < 2) ? Data[3] : true;
	gSetting_500TX             = (Data[4] < 2) ? Data[4] : true;
